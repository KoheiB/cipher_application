...
responses.forEach(function(response) {
  objects.push({
    ...
    cc_cost:        response[6],
    symbols:        [ response[7], response[8] ],
    gender:         response[9],
    weapon:         response[10],
    types:          [ response[11], response[12], response[13], response[14] ],
    n_skills:       [{name: response[15], text: response[19]},
                     {name: response[16], text: response[20]},
                     {name: response[17], text: response[21]},
                     {name: response[18], text: response[22]}],
    s_skills:       [{name: response[23], text: response[25]},
                     {name: response[24], text: response[26]}],
    c_power:        response[27],
    s_power:        response[28],
    range:          response[29],
    class:          response[30],
